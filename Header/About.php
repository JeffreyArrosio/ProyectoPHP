...
<body>
    ...
    <main class="container">
        ...
        <ul class="h2">
            <li>Misión: Proveer a nuestros clientes con productos de alta calidad y un servicio superior.</li>
            <li>Visión: Ser la tienda de referencia para gamers y entusiastas de la tecnología en todo el mundo.</li>
            <li>Valores: Pasión, Innovación, Compromiso y Transparencia.
            </li>
        </ul>
    </main>
